...
activate :i18n, :mount_at_root => :ENV['ENVIRONMENT'], :langs => [:ENV['ENVIRONMENT']]
...
configure :build do
  ...
  activate :asset_hash, :exts => app.config[:asset_extensions] - %w[.woff .woff2], :ignore => [/^openapi\/.*/]
  # If you're having trouble with Middleman hanging, commenting
  # out the following two lines has been known to help
  activate :minify_css, :ignore => [/^openapi\/.*/]
  activate :minify_javascript, :ignore => [/^openapi/]
  # activate :gzip
end
